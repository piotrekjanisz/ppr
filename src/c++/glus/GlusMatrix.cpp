...
GLUSvoid GLUSAPIENTRY Glus::glusLoadIdentityf(GLUSfloat matrix[16])
{
    matrix[0] = 1.0f;
    matrix[1] = 0.0f;
    matrix[2] = 0.0f;
...
GLUSvoid GLUSAPIENTRY Glus::glusCopyMatrixf(GLUSfloat matrix[16], const GLUSfloat source[16])
{
    GLUSuint i;
...
GLUSvoid GLUSAPIENTRY Glus::glusMultMatrixf(GLUSfloat matrix[16], const GLUSfloat matrix0[16], const GLUSfloat matrix1[16])
{
    GLUSuint i;
    GLUSuint k;
...
GLUSboolean GLUSAPIENTRY Glus::glusInverseMatrixf(GLUSfloat matrix[16], const GLUSfloat source[16])
{
    GLUSuint i;
...
GLUSvoid GLUSAPIENTRY Glus::glusTransposef(GLUSfloat matrix[16])
{
    GLUSuint column;
    GLUSuint row;
...
GLUSvoid GLUSAPIENTRY Glus::glusTranslatef(GLUSfloat matrix[16], GLUSfloat x, GLUSfloat y, GLUSfloat z)
{
    GLUSfloat temp[16];
...
GLUSvoid GLUSAPIENTRY Glus::glusRotatef(GLUSfloat matrix[16], GLUSfloat angle, GLUSfloat x, GLUSfloat y, GLUSfloat z)
{
    GLUSfloat temp[16];
...
GLUSvoid GLUSAPIENTRY Glus::glusRotateRzRyRxf(GLUSfloat matrix[16], GLUSfloat anglex, GLUSfloat angley, GLUSfloat anglez)
{
    GLUSfloat temp[16];
...
GLUSvoid GLUSAPIENTRY Glus::glusScalef(GLUSfloat matrix[16], GLUSfloat x, GLUSfloat y, GLUSfloat z)
{
    GLUSfloat temp[16];
...
GLUSvoid GLUSAPIENTRY Glus::glusMultVectorf(GLUSfloat result[3], const GLUSfloat matrix[16], const GLUSfloat vector[3])
{
    GLUSuint i;
...
GLUSvoid GLUSAPIENTRY Glus::glusMultPointf(GLUSfloat result[4], const GLUSfloat matrix[16], const GLUSfloat vector[4])
{
    GLUSuint i;
